...
* `3. 11`
  * [3-set_bit.c](./3-set_bit.c): C function that will set the value of a bit at a given index
  to `1`.
  * If an error occurs - returns `-1`.
  * Otherwise - returns `1`.
* `4. 100`
...
* `7. Crackme3`
  * [101-password](./101-password): File containing password for the crackme3 executable.
